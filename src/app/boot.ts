...
export async function addTrackPlayerTracks(turns: ITurn[], isImpression: boolean) {
  const _tracks = turnArrayToTracksMapper(turns, isImpression);
  try {
...
export function turnArrayToTracksMapper(turns: ITurn[], isImpression: boolean): Track[] {
